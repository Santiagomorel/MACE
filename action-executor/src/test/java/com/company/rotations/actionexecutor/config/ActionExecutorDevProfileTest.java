...
@SpringBootTest
@ActiveProfiles("dev")
class ActionExecutorDevProfileTest {
    ...
    void devProfileShouldHaveDebugLogging() {
        String executorLogLevel = environment.getProperty("logging.level.com.company.rotations.actionexecutor");
        assertNotNull(executorLogLevel, "Action executor log level should be configured");
        assertTrue(executorLogLevel.equals("DEBUG") || executorLogLevel.equals("debug"),
                "Dev profile should have DEBUG logging level: " + executorLogLevel);
    }
}
